...
;General
  ...
  Name "Custom QFlipper"
  OutFile "build\CustomQFlipperSetup-${ARCH_BITS}bit.exe"
  ...
  ; Sign the Uninstaller.exe file (disabled — no signing tool available)
  ...
  VIAddVersionKey "FileDescription" "Custom QFlipper Windows Installer"
  VIAddVersionKey "FileVersion" "${VERSION}.0"
  VIAddVersionKey "ProductName" "Custom QFlipper"  
  VIAddVersionKey "ProductVersion" "${VERSION}.0"
  VIAddVersionKey "CompanyName" "FilipTechLab"
  VIAddVersionKey "LegalCopyright" "(C) 2022 Flipper Devices Inc. / (C) 2026 FilipTechLab"

;--------------------------------
;Installer wizard pages

  ; Global window title 
  Caption "Custom QFlipper ${VERSION} Setup"
  ...
  !define MUI_WELCOMEPAGE_TITLE  "Welcome To Custom QFlipper Setup"
  !define MUI_WELCOMEPAGE_TEXT "Custom QFlipper is a desktop application for updating Flipper Zero and T-Embed firmware and databases, manage files on SD card, and repair corrupted device.$\r$\n$\r$\n$\r$\n$\r$\n$\r$\nCredits$\r$\nCode:   Georgii Surkov$\r$\nDesign: Valerie Aquamine, Dmitry Pavlov$\r$\nCustomization: FilipTechLab$\r$\n$\r$\nOpen Source and Distributed under GPL v3 License$\r$\nCopyright (C) 2022 Flipper Devices Inc.$\r$\nCopyright (C) 2026 FilipTechLab"
  ...
  !define MUI_FINISHPAGE_TITLE "Custom QFlipper ${VERSION} Setup Complete"
