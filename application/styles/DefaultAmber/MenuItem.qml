...
T.MenuItem {
    ...
    property var foregroundColor: ColorSet {
        normal: destructive ? Theme.lightred4 : Theme.lightorange2
        hover: destructive ? Theme.lightred4 : Theme.lightorange1
        down: destructive ? Theme.darkred1 : Theme.darkorange1
        disabled: destructive ? Theme.mediumred1 : Theme.mediumorange1
    }

    property var backgroundColor: ColorSet {
        normal: Theme.darkorange1
        hover: destructive ? Theme.mediumred2 : Theme.mediumorange2
        down: destructive ? Theme.lightred4 : Theme.lightorange2
