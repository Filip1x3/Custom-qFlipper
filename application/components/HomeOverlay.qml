...
AbstractOverlay {
    ...
    ColumnLayout {
        ...
        TransparentLabel {
            ...
            color: (!deviceState || !deviceState.isOnline) ? Theme.lightred1 : deviceState.isRecoveryMode ?
                                           Theme.lightblue : Theme.lightgreen
    ...
    Action {
        ...
        onTriggered: Qt.openUrlExternally("https://sor3nt.github.io/interface.html")
    }
