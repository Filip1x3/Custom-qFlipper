...
Item {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            TextLabel {
                color: extraFields ? "#999999" : "#c0c0c0"
                text: qsTr("Hardware")
                horizontalAlignment: Text.AlignRight
                Layout.fillWidth: true
            }
        ...
        ColumnLayout {
            ...
            TextLabel {
                ...
                color: deviceInfo && deviceInfo.storage.isExternalPresent ? "#a0a0a0" : Theme.lightred3
                visible: extraFields
            }

            TextLabel {
                text: deviceInfo && deviceInfo.storage.isAssetsInstalled ? qsTr("Installed") : qsTr("Missing")
                color: deviceInfo && deviceInfo.storage.isAssetsInstalled ? "#a0a0a0" : Theme.lightred3
                visible: extraFields
            }

            TextLabel {
                color: extraFields ? "#a0a0a0" : "#c0c0c0"
            ...
            TextLabel {
                ...
                color: deviceInfo && deviceInfo.radioVersion.length ? "#a0a0a0" : Theme.lightred3
                visible: extraFields
            }
        }
    }
